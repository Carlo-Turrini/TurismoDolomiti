...
public interface FotoRepository extends JpaRepository<Foto, Long> {
	...
	@Query("SELECT new com.student.project.TurismoDolomiti.dto.FotoSequenceDTO(f.photoPath, f.timestamp) FROM Foto f WHERE f.elemento.id = :id_elemento ORDER BY f.timestamp")
